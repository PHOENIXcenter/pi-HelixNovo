...
Tingpeng Yang, Tianze Ling, Boyan Sun, Zhendong Liang, Cheng Lai, Jiangli Hu, Zexuan Yi, Yonghong He, Leyuan Li, Yue Yu, Cheng Chang, Yu Wang, π-HelixNovo2: Making Accurate Online De Novo Peptide Sequencing Available to All, Genomics, Proteomics & Bioinformatics, 2026;, qzag049, https://doi.org/10.1093/gpbjnl/qzag049
...
# Recommendation
For practical large-scale de novo peptide sequencing, we highly recommend utilizing the model weight ["Evaluation_on_MassIVE-KB_dataset.zip/ModelWeights/pi-helixnovo_massivekb.ckpt"](https://zenodo.org/records/16735542/files/Evaluation_on_MassIVE-KB_dataset.zip?download=1), which was trained on the large-scale MassIVE-KB dataset, while employing the "config.yaml" configuration file.
